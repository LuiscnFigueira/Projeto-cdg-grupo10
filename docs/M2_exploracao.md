...
#### 1.9.1 Verificação de Normalidade - Teste de _Shapiro-Wilk_
...
#### 1.9.2 Variáveis Numéricas - Teste de _Mann-Whitney U_
...
#### 1.9.4 Variáveis Ordinais - Teste de _Kruskal-Wallis_
