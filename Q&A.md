## 1. "Como sabem que os clusters são válidos e não um artefacto do algoritmo?"
...
## 2. "O dataset IBM é sintético. O que isso implica para os vossos resultados?"
...
## 3. "Porquê Regressão Logística e não um modelo mais sofisticado?"
...
## 4. "O índice de risco é uma ferramenta de apoio à decisão. Mas não pode ser usado para discriminar colaboradores?"
...
## 5. "O OverTime é o fator mais importante. Mas isso não é óbvio? Qual é o valor analítico?"
...
## 6. "Porquê o split 65/35 e não o tradicional 80/20?"
...
## 7. "Como trataram as variáveis categóricas? E as variáveis com distribuições muito assimétricas?"
...
## 8. "Os quatro perfis de clustering — que intervenções concretas sugerem para cada um?"
...
## 9. "Se tivessem que apresentar este projeto a um CEO em dois minutos, o que diriam?"

**Resposta:** Um em cada seis colaboradores desta organização vai sair no próximo ano — e não sabem qual. Cada saída tem um custo real: recrutamento, formação, perda de conhecimento. Desenvolvemos um sistema que analisa os dados de RH e classifica cada colaborador em quatro níveis de
